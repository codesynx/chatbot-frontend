...
const LoginPage = () => {
	...
	return (
		<motion.div
			...
			className='max-w-md w-full bg-blue-800 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl 
                 overflow-hidden'>
			...
			<div className='p-8'>
				...
				<form onSubmit={handleLogin}>
					...
					<motion.button
                       ...
                       hover:from-blue-600 hover:to-sky-700 focus:outline-none focus:ring-2 focus:ring-blue-500 
